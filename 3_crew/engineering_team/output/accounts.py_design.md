...
This modular design provides a complete account management system cohesive with the specified functionality. The `Account` class encapsulates all functionality allowing users to manage their accounts effectively, ensuring all operations adhere to the rules specified. The implementation of the `get_share_price` function simulates the retrieval of current stock prices.